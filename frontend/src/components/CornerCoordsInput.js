...
const CornersCoordsInput = (props) => {
  ...
  return (
    <div>
      ...
      <button className="btn btn-danger" onClick={props.onUndo}><i className="fas fa-undo"></i> Back</button> <button className="btn btn-primary" onClick={onSubmit}><i className="fas fa-arrow-alt-circle-right"></i> Next</button>
    </div>
  )
}
