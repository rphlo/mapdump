    ...
    <GlobalStateProvider>
      <Router basename='/'>
        <div className="jumbotron text-center">
          <div style={{width: "100%", height: "100%", "backgroundColor": "#33333366", position: "absolute", top: "0", left: "0", zIndex: -1}}></div>
          <Link to='/' onClick={onClickHome} style={{textDecoration: 'none', color:'#f3f', textShadow: "-1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff"}}><h1 style={{whiteSpace: 'nowrap'}}><img src="/static/logo.svg" alt="logo" height="60px" style={{margin: "0 -10px 0 -14px"}} /> <small>Mapdump.com</small></h1>
          <p style={{padding: '0 0 30px 0', margin: '-10px 0 0 0'}}>WHERE YOUR MAPS END THEIR LIFE...</p></Link>
