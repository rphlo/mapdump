      ...
      <div className="container" style={{ textAlign: "center" }}>
          ...
          {!username && (
           ...
           >
             ...
             </Link><span style={{ fontSize: ".7em", fontWeight: "normal"}}> or <Link to={"/login"}>Login</Link></span>
             </div>
             <hr/>
             <div>
             <Link to="/new">Test without Registering</Link><br/><Link to="/map">Browse Maps</Link></div>
           </div>
          )}
      </div>
